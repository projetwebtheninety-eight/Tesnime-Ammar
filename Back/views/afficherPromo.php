...
<td><img src=<?php echo $l['image']; ?> alt=""></td>
              ...
              <td><?php echo $l['prixred'] ?></td>
             <td><?php echo $l['like_promo'] ?></td>
              <td><?php echo $l['dislike'] ?></td>
              
              <td>
                <a href="modifierPromo.php?id=<?php echo $l['id'] ?>">Modifier</a>
                <a href="supprimerPromo.php?id=<?php echo $l['id'] ?>">Supprimer</a>
          ...
          <a class="btn btn-success" href="ajouterPromo.php">Ajouter</a>  
